            ...
            <Modal.Body>
                {
                    ...
                    <thead className='bg-table-header'>
                        <tr className='text-sm'>
                            <th className='rounded-tr-2.5x py-3 text-center'>نام نماد</th>
                            <th className='rounded-tl-2.5x py-3 text-center'>کامنت</th>
                        </tr>
                    </thead>
                ...
                :
                <div className='text-sm text-center text-gray-400'>هیچ کامنتی وجود ندارد</div>
                }
